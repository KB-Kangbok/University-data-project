...
```{r}
<<<<<<< HEAD
top5Uni <- filter(College_final, INSTNM %in% c("Harvard University", "Cornell University", "University of Pennsylvania","Princeton University", "Yale University","Stanford University","University Of Michigan","Duke University","University of Georgia", "University of Notre Dame","Brown University")) %>% select(REGION,INSTNM,ADM_RATE,RET_FT4) 

kable(top5Uni, caption = "Admissions vs. Retention (Top 5 Ivy. Universities")
```
=======
library(knitr)
...
>>>>>>> 6357db0ed11f509a6519cdfe0351d40dc5e910ea
