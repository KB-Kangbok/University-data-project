...
In this graph, it seeks to look into the relationship between two scenarios:
1. The average tuition rates (yearly) according to the admission rates of college institutions categorized into each decile.
2. The average annual salaries of graduates (those who gr)
