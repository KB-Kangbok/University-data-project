...
Within this diagram, we wanted to look a bit more closely at the relationship between the average tutition costs of the universities & average salary payoffs for the student populus at these universities.As you take a glance at the legend on the graph as well, you can see that it indicates highest to lowest `ADM_RATE` (admissions rate) values signified by lightest to darkest coloring. With these three factors within the diagram, some key takeaways that you can have is that: 1) The lower the admission's rate, the higher the tutiton. 2) Those with attended universities with a 10,000 tution rate/yr made on average 40,000 a year after graduation. 3) Those with a higher tuition rate & lower admissions rate, made more money, salary wise, after graduation.
...
<<<<<<< HEAD
In parsing through the US college data & sharing our individual questions of interest, these graphs were what our group generated to explore the dynamic relationship between the college institutions & their overall return on investment. The dynamics we took a closer 
=======
Some shocking results we came across that contributes greatly to the discussions of ROI's were: 1) The Ivy to have the lowest average salary after graduate was Brown University, even with a higher admissions rate than second lowest Ivy, Yale. 2) The D1 University to have the lowest average salary after graduating was University of Georgia, with a relatively high admissions & retention rate.
>>>>>>> 10766b458dbb80615401920432abc4db4eb2e4f6
